...
async function main() {
  ...
  const productsData = [
    ...
    },
    {
      ...
      description: "Sophisticated craftsmanship featuring an ultra-slim stainless steel case, sapphire crystal glass, and a genuine calfskin leather strap. Water-resistant up to 50m with precision quartz chronograph movement.",
      details: "Case Size: 40mm\nStrap: Genuine Italian Leather\nGlass: Scratch-resistant Sapphire Crystal\nMovement: Japanese Quartz Chronograph\nWater Resistance: 5 ATM",
      categorySlug: "watches-and-timepieces",
      price: 3499,
      discountPrice: 2799,
      stock: 18,
      availability: true,
      ...
      variants: [
        { size: "One Size", colour: "Rose Gold / Brown Leather", stock: 10 },
        { size: "One Size", colour: "Midnight Black / Silver", stock: 8 },
      ],
    },
    {
      sku: "SH-801",
      ...
      description: "Timeless penny loafers hand-stitched from full-grain supple calfskin leather. Cushioned memory-foam insole and flexible rubber tread for effortless day-to-evening comfort.",
      details: "Upper: 100% Full Grain Calfskin Leather\nLining: Breathable Leather\nSole: Durable Rubber & Wood Stack\nFit: Standard UK/India sizing",
      categorySlug: "footwear-and-shoes",
      price: 4299,
      discountPrice: 3499,
      stock: 22,
      availability: true,
      ...
      variants: [
        { size: "UK 7", colour: "Cognac Tan", stock: 4 },
        { size: "UK 8", colour: "Cognac Tan", stock: 6 },
        { size: "UK 9", colour: "Cognac Tan", stock: 6 },
        { size: "UK 8", colour: "Rich Black", stock: 3 },
        { size: "UK 9", colour: "Rich Black", stock: 3 },
      ],
    },
  ];
